...
export default function ProductsFor(props) {
  return (
   <>
   <Link to={"/"+props.wee}><div className="max-w-sm bg-white px-6 pt-6 pb-2 rounded-xl shadow-lg transform hover:scale-105  mb-5 transition duration-500">
