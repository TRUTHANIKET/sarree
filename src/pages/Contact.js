    ...
    <div className="container px-6 py-12 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 sm:grid-cols-2 lg:grid-cols-3 ">
            <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                ...
                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">textilesphemant@gmail.com</p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                ...
                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">57/59, Dr. A.M Road, Jawahar Mansion,</p>
                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400"> 1
st Floor Bhuleshwar, Mumbai-400002</p>
            </div>
            ...
            <div className="p-4 rounded-lg bg-blue-50 md:p-6 dark:bg-gray-800">
                ...
                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">+91 9920255088</p>
                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">+91 8879734521</p>
                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">+91 8879734522</p>
                <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">+91 9322141043</p>
            </div>
        </div>
    </div>
</section>
